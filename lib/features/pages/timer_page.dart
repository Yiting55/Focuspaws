...
import 'package:focuspaws/features/pages/focus_activity.dart';
...
class _TimerPageState extends State<TimerPage> with WidgetsBindingObserver{  
  ...
  void _saveFocusActivity(bool isSuccess) async {
    String focusName = 'Focus Session';
    FocusActivity focusActivity = FocusActivity(
      name: focusName, 
      duration: _totalTime, 
      isSuccess: isSuccess,
    );
    CollectionReference allFocusActivity = FirebaseFirestore.instance.collection('allFocusActivity');
