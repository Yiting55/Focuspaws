...
import 'package:focuspaws/features/pages/healthBar.dart';
import 'package:focuspaws/features/alert/Alert.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  late DateTime _lastCookTime = DateTime.now().subtract(Duration(hours: 7));
